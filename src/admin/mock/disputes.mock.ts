...
export const mockDisputes: DisputeOrder[] = [
  ...
  { id: 'D-4395', time: '2026-06-26 23:06', orderId: 'O-78931', epalId: 'U10104', epalName: 'Aria_Flow', userId: 'U10091', userName: 'ShadowReap', serviceType: '语音聊天', unitPrice: 60, quantity: 1, total: 60, evidence: ['聊天截图 3 张'], status: '复审中' },
];
