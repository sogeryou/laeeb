...
export const mockWithdrawals: WithdrawalRow[] = [
  ...
  { id: 'W-2362', requestedAt: '2026-06-27 09:10', userId: 'U10082', userName: 'Lumina_Sky', accountStatus: '正常', channel: 'Bank', diamonds: 8000, diamondsUsd: 80, remainingDiamonds: 9360, fee: 4, netUsd: 76, orderId: 'WD2026062700', info: 'IBAN **** 9132', status: '待审核' },
